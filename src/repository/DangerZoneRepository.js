...
var ConcreteDangerZoneRepository = /** @class */ (function () {
    ...
    ConcreteDangerZoneRepository.prototype.insert = function (dangerZone) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.database.insert(dangerZone)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ConcreteDangerZoneRepository.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            var items;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ConcreteDangerZoneRepository.prototype.findById = function (dangerZoneId) {
        return __awaiter(this, void 0, void 0, function () {
            var item;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ], ConcreteDangerZoneRepository.prototype, "database", void 0);
