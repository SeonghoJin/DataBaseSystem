...
var comment = /** @class */ (function () {
    function comment(app) {
        ...
        this.router.post('', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var comment, name, hcid;
            var _a, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        if (((_a = req.session.user) === null || _a === void 0 ? void 0 : _a.name) === null) {
                            res.sendStatus(400);
                            return [2 /*return*/];
                        }
                        ;
                        comment = (_b = req.fields) === null || _b === void 0 ? void 0 : _b.comment;
                        name = (_c = req.session.user) === null || _c === void 0 ? void 0 : _c.name;
                        hcid = (_d = req.fields) === null || _d === void 0 ? void 0 : _d.hcid;
